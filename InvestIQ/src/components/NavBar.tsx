      ...
      >
        <div className="max-w-[1080px] container flex flex-wrap justify-between items-center mx-auto">
          <Link href="/" className="flex items-center flex-1">
            <span className="flex flex-row items-end self-center font-['trap'] text-100 text-2xl whitespace-nowrap">
              <Image
                src="/finn.png"
                width="40"
                height="40"
            ...
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-md md:font-medium">
              ...
              <li>
                <Link
                  ...
                  className={`${
                    pathname === "/" ? "underline" : ""
                  } block underline-offset-4 py-2 pr-4 pl-3 text-300 hover:text-teal-400 border-b border-neutral-400 hover:bg-neutral-800 md:hover:bg-transparent md:border-0 md:hover:font-bold md:p-0`}
                  aria-current="page"
                >
                  Home
                </Link>
              ...
              <Menu as="div" className="relative inline-block w-full text-left">
                <div>
                  <Menu.Button className="inline-flex w-full items-center py-2 pr-4 pl-3 text-300 hover:text-teal-400 border-b border-neutral-400 hover:bg-neutral-800 md:hover:bg-transparent md:border-0 md:hover:font-bold md:p-0">
                    Profile
