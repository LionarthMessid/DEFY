...
const quoter_custom_preset_request_1 = require("../api/quoter/quoter-custom-preset.request");
class FusionSDK {
    constructor(config) {
        this.config = config;
    ...
    getQuoteWithCustomPreset(params, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const bodyRequest = quoter_custom_preset_request_1.QuoterCustomPresetRequest.new({
    ...
    createOrder(params) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const quote = yield this.getQuoteResult(params);
            if (!quote.quoteId) {
            ...
            const order = quote.createFusionOrder({
                ...
                nonce,
                permit: params.permit,
                takingFeeReceiver: (_a = params.fee) === null || _a === void 0 ? void 0 : _a.takingFeeReceiver
            });
    ...
    getQuoteResult(params) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const quoterWithCustomPresetBodyRequest = quoter_custom_preset_request_1.QuoterCustomPresetRequest.new({
                customPreset: params.customPreset
            });
            const quote = yield this.api.getQuoteWithCustomPreset(quoterRequest, quoterWithCustomPresetBodyRequest);
            return quote;
        });
    }
